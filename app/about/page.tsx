      ...
      <main className="flex-1 w-full">
        ...
        <section className="w-full px-4 lg:px-6 py-12 md:py-24">
          <h1 className="text-3xl md:text-5xl lg:text-[56px] font-bold tracking-tight uppercase leading-[1.1] mb-12 lg:mb-24 max-w-6xl text-black">
            BETWEEN TRADITION AND TOMORROW, pátákó FINDS BALANCE. FURNITURE ROOTED IN CRAFT, DESIGNED FOR NOW.
          </h1>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-24">
            <div className="relative w-full aspect-square md:aspect-[4/5] bg-stone-200">
              <Image src="/src/1.jpg" alt="pátákó Chair" fill priority sizes="(max-width: 768px) 100vw, 50vw" className="object-cover transition-transform duration-700 hover:scale-[1.02] cursor-pointer" />
            </div>
            <div className="flex flex-col justify-end pb-8 lg:pb-12">
              <h2 className="text-2xl md:text-3xl lg:text-[32px] font-bold tracking-tight uppercase leading-snug max-w-lg text-black">
                pátákó HONORS THE SLOW HAND AND THE PATIENT EYE. CREATING SPACES WHERE SIMPLICITY FEELS LIKE LUXURY.
              </h2>
            </div>
          </div>
        </section>
        ...
        <section className="w-full px-4 lg:px-6 py-16 md:py-24 bg-white">
          <h3 className="text-3xl md:text-4xl lg:text-[42px] leading-snug md:leading-[1.2] text-black mb-12 lg:mb-20 max-w-6xl font-normal">
            This is pátákó. We honor the quiet dialogue between Japanese and Scandinavian form. Our work exists at the intersection of precision and simplicity, creating furniture that invites contemplation.
          </h3>
          <div className="relative w-full aspect-[16/9] lg:aspect-[2.5/1] bg-stone-200 overflow-hidden">
             <Image src="/src/2.jpg" alt="pátákó Furniture" fill sizes="100vw" className="object-cover transition-transform duration-700 hover:scale-[1.02] cursor-pointer" />
          </div>
        </section>
        ...
        <section className="w-full px-4 lg:px-6 pb-24 md:pb-32">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24">
            ...
            <div className="relative w-full aspect-square md:aspect-[4/5] bg-stone-200 order-1 md:order-2 overflow-hidden">
               <Image src="/src/3.jpg" alt="Crafting Process" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover transition-transform duration-700 hover:scale-[1.02] cursor-pointer" />
            </div>
          </div>
        </section>
